...
require_multi(
	...
	'menus', 'library', 'scripts', 'images', 'search', 'emergency', 'articles', 'video-showcase', 'icons', 'post-type/area', 'accordion', 'button', 'page-header', 'call-to-action', 'hep/send-donation'
