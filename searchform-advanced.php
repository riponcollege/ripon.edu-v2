<form role="search" method="get" id="searchform" class="searchform" action="/" _lpchecked="1">
	...
	<label><input type="checkbox" name="post_type[]" value="guide"<?php print ( isset( $_REQUEST['post_type'] ) ? ( in_array( 'guide', $_REQUEST['post_type'] ) ? ' checked="yes"' : '' ) : '' ) ?> /> Research Guides</label>
	<?php } ?>
