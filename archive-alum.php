...
if ( $current_yr > 0 ) {
	...
	while ( have_posts() ) : 
		...
		global $post;
		$year_info = array();
		$year_info['president'] = get_cmb_value_noprefix( 'year_president' );
		$year_info['grad_date'] = get_cmb_value_noprefix( 'year_grad_date' );
		$year_info['grad_seniors'] = get_cmb_value_noprefix( 'year_grad_seniors' );
		$year_info['commencement_theme'] = get_cmb_value_noprefix( 'year_commencement_theme' );
		$year_info['commencement_speakers'] = get_cmb_value_noprefix( 'year_commencement_speakers' );
		$year_info['honorary_degrees'] = get_cmb_value_noprefix( 'year_honorary_degrees' );
		$year_info['medal'] = get_cmb_value_noprefix( 'year_medal' );
		$year_info['agent_current_name'] = get_cmb_value_noprefix( 'year_agent_current_name' );
		$year_info['agent_current_email'] = get_cmb_value_noprefix( 'year_agent_current_email' );
		$year_info['agent_current_name_2'] = get_cmb_value_noprefix( 'year_agent_current_name_2' );
		$year_info['agent_current_email_2'] = get_cmb_value_noprefix( 'year_agent_current_email_2' );
		$year_info['agent_current_name_3'] = get_cmb_value_noprefix( 'year_agent_current_name_3' );
		$year_info['agent_current_email_3'] = get_cmb_value_noprefix( 'year_agent_current_email_3' );
		$year_info['agent_current_name_4'] = get_cmb_value_noprefix( 'year_agent_current_name_4' );
		$year_info['agent_current_email_4'] = get_cmb_value_noprefix( 'year_agent_current_email_4' );
		$year_info['agent_former_name'] = get_cmb_value_noprefix( 'year_agent_former_name' );
		$year_info['has_memory'] = get_cmb_value_noprefix( 'year_memory' );
		$year_info['has_green'] = get_cmb_value_noprefix( 'year_green' );

		$year_info['memories'] = array();
		if ( has_cmb_value_noprefix( 'year_memory_50' ) ) $year_info['memories'][50] = get_cmb_value_noprefix( 'year_memory_50' );
		if ( has_cmb_value_noprefix( 'year_memory_40' ) ) $year_info['memories'][40] = get_cmb_value_noprefix( 'year_memory_40' );
		if ( has_cmb_value_noprefix( 'year_memory_35' ) ) $year_info['memories'][35] = get_cmb_value_noprefix( 'year_memory_35' );
		if ( has_cmb_value_noprefix( 'year_memory_25' ) ) $year_info['memories'][25] = get_cmb_value_noprefix( 'year_memory_25' );
		if ( has_cmb_value_noprefix( 'year_memory_10' ) ) $year_info['memories'][10] = get_cmb_value_noprefix( 'year_memory_10' );
		

		$year_info['letters'] = get_cmb_value_noprefix( 'year_letters' );
		$year_info['facebook'] = get_cmb_value_noprefix( 'year_facebook' );
		$year_info['news'] = get_cmb_value_noprefix( 'year_news' );
		$year_info['sightings'] = get_cmb_value_noprefix( 'year_sightings' );

		$year_info['photo'] = get_the_post_thumbnail_url( $post, 'full' );
		$year_info['photo_thumb'] = get_the_post_thumbnail_url( $post, array( 400, 400 ) );
		$year_info['photo_reunion'] = get_cmb_value_noprefix( 'year_photo_reunion' );
	endwhile;
	wp_reset_query();
	// print_r( $year_info );
}
